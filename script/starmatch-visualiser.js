...
// function getRelationshipTypeInterpretation(xProfileValue) - superfluous and misleading

// in 'Apply engine settings to global variables from engine.js'
// window.orbType = parseInt(orbTypeSelect.value);
// poIndex needs defining here as 0, 1 - Lilly, al-Biruni

// in 'Determine aspect type name'
// const aspectTypes = {
// missing: 30: 'Semi-sextile',		  
// missing: 45: 'Semi-square',

// removed: the nearer to zero the better the fit... that's all
//function getRelationshipTypeInterpretation

// end corrections/additions/alterations
...
// what's this: the sole determinant in compatibility is complementarity...
//for which fit == 0
